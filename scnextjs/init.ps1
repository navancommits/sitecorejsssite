...
Add-HostsEntry "cm.scnextjs.localhost"
if ($Topology -ne "xp0") {
  Add-HostsEntry "cd.scnextjs.localhost"
}
Add-HostsEntry "id.scnextjs.localhost"
Add-HostsEntry "www.scnextjs.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.scnextjs.localhost"

    if ($Topology -ne "xp0") {
      # CD_HOST
      Set-EnvFileVariable "CD_HOST" -Value "cd.scnextjs.localhost"
    }

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.scnextjs.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.scnextjs.localhost"
