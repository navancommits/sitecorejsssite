...
if ($ByPass) {
  dotnet sitecore login --cm https://cm.scnextjs.localhost/ --auth https://id.scnextjs.localhost/ --allow-write true --client-id "SitecoreCLIServer" --client-secret "testsecret" --client-credentials true
}else {
  dotnet sitecore login --cm https://cm.scnextjs.localhost/ --auth https://id.scnextjs.localhost/ --allow-write true
}
...
Start-Process https://cm.scnextjs.localhost/sitecore/
Start-Process https://www.scnextjs.localhost/
